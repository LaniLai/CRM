...
SECRET_KEY = 'f9)rwp&ql&v5tk=s=sx$)2ca*dyg88*^6qn0=c4f&l65pg!0@f'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'BossAdmin/templates')
        ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
...
STATICFILES = (
    os.path.join(BASE_DIR, 'BossAdmin/static'),
    os.path.join(BASE_DIR, 'static'),
)

LOGIN_URL = '/bossadmin/login/'
